    ...
    <SafeAreaView style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.hero}>
          <PulseIcon size={84} dotColor={colors.signalBlue} />
          <Text style={styles.title}>Block Fill</Text>
          <Text style={styles.tagline}>Drag through every open cell to fill the board. Stuck? Rewind along your own trail and try another route.</Text>
        </View>
        ...
        <View style={styles.secondaryRow}>
          <TouchableOpacity style={styles.secondaryBtn} activeOpacity={0.75} onPress={() => navigation.navigate('BlockFillLevels')}>
            <Text style={styles.secondaryBtnText}>Levels</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.secondaryBtn}
            activeOpacity={0.75}
            onPress={() => navigation.navigate('BlockFillTutorial', { tutorialKey: 'all', pendingLevelIndex: null })}
          >
