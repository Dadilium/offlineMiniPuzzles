...
export type MatchingNumbersStackParamList = {
  MatchingNumbersHub: undefined;
  MatchingNumbersLevels: undefined;
  ...
  MatchingNumbersTutorial: { tutorialKey: string; pendingLevelIndex: number | null };
  MatchingNumbersGame: { levelIndex: number };
};
