    ...
    <SafeAreaView style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.hero}>
          <PulseIcon size={84} dotColor={colors.purple} />
          <Text style={styles.title}>Matching Numbers</Text>
          <Text style={styles.tagline}>
            Clear the board by matching tiles that are equal or sum to 10, connected by a straight or single-bend path.
          </Text>
        </View>
        ...
        <View style={styles.secondaryRow}>
          <TouchableOpacity style={styles.secondaryBtn} activeOpacity={0.75} onPress={() => navigation.navigate('MatchingNumbersLevels')}>
            <Text style={styles.secondaryBtnText}>Levels</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.secondaryBtn}
            activeOpacity={0.75}
            onPress={() => navigation.navigate('MatchingNumbersTutorial', { tutorialKey: 'all', pendingLevelIndex: null })}
          >
