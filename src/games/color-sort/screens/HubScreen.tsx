    ...
    <SafeAreaView style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.hero}>
          <PulseIcon size={84} dotColor={colors.cyan} />
          <Text style={styles.title}>Color Sort</Text>
          <Text style={styles.tagline}>
            Pour colors between tubes until every color lands in one tube of its own.
          </Text>
        </View>
        ...
        <View style={styles.secondaryRow}>
          <TouchableOpacity style={styles.secondaryBtn} activeOpacity={0.75} onPress={() => navigation.navigate('ColorSortLevels')}>
            <Text style={styles.secondaryBtnText}>Levels</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.secondaryBtn}
            activeOpacity={0.75}
            onPress={() => navigation.navigate('ColorSortTutorial', { tutorialKey: 'all', pendingLevelIndex: null })}
          >
