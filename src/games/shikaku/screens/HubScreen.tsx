    ...
    <SafeAreaView style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.hero}>
          <PulseIcon size={84} dotColor={colors.signalRed} />
          <Text style={styles.title}>Shikaku</Text>
          <Text style={styles.tagline}>Partition the grid into rectangles — each one's area must match the clue it covers.</Text>
        </View>
        ...
        <View style={styles.secondaryRow}>
          <TouchableOpacity style={styles.secondaryBtn} activeOpacity={0.75} onPress={() => navigation.navigate('ShikakuLevels')}>
            <Text style={styles.secondaryBtnText}>Levels</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.secondaryBtn}
            activeOpacity={0.75}
            onPress={() => navigation.navigate('ShikakuTutorial', { tutorialKey: 'all', pendingLevelIndex: null })}
          >
